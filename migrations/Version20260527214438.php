 ...
 */
final class Version20260527214438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application CHANGE candidate_profile_id candidate_profile_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application CHANGE candidate_profile_id candidate_profile_id INT NOT NULL');
