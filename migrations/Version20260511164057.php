 ...
 */
final class Version20260511164057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE application (id INT AUTO_INCREMENT NOT NULL, statut VARCHAR(50) NOT NULL, date_candidature DATETIME NOT NULL, message_motivation LONGTEXT DEFAULT NULL, candidate_profile_id INT NOT NULL, job_offer_id INT NOT NULL, INDEX IDX_A45BDDC1FE3D0586 (candidate_profile_id), INDEX IDX_A45BDDC13481D195 (job_offer_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
