 ...
 */
final class Version20260512205608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD accepted_terms_at DATETIME DEFAULT NULL, ADD accepted_privacy_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP accepted_terms_at, DROP accepted_privacy_at');
    }
}
